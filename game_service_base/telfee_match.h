...
public:
	...
	match_wait_begin_task(boost::asio::io_service& ios) : task_info(ios)
	{
...
public:
	match_ptr the_match_;
	match_wait_end_task(boost::asio::io_service& ios) : task_info(ios)
	{
...
public:
	match_ptr the_match_;
	match_wait_register_task(boost::asio::io_service& ios) : task_info(ios)
	{
...
public:
	match_ptr the_match_;
	match_wait_start_task(boost::asio::io_service& ios) : task_info(ios)
	{
